...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/Asteroid-0.png", __ASSET__assets_images_asteroid_0_png);
		type.set ("assets/images/Asteroid-0.png", AssetType.IMAGE);
		className.set ("assets/images/Asteroid-1.png", __ASSET__assets_images_asteroid_1_png);
		type.set ("assets/images/Asteroid-1.png", AssetType.IMAGE);
		className.set ("assets/images/Asteroid-2.png", __ASSET__assets_images_asteroid_2_png);
		type.set ("assets/images/Asteroid-2.png", AssetType.IMAGE);
		className.set ("assets/images/Asteroid-3.png", __ASSET__assets_images_asteroid_3_png);
		type.set ("assets/images/Asteroid-3.png", AssetType.IMAGE);
		...
		id = "assets/images/Asteroid-0.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Asteroid-1.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Asteroid-2.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Asteroid-3.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_asteroid_0_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_asteroid_1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_asteroid_2_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_asteroid_3_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/Asteroid-0.png") #if display private #end class __ASSET__assets_images_asteroid_0_png extends lime.graphics.Image {}
@:image("assets/images/Asteroid-1.png") #if display private #end class __ASSET__assets_images_asteroid_1_png extends lime.graphics.Image {}
@:image("assets/images/Asteroid-2.png") #if display private #end class __ASSET__assets_images_asteroid_2_png extends lime.graphics.Image {}
@:image("assets/images/Asteroid-3.png") #if display private #end class __ASSET__assets_images_asteroid_3_png extends lime.graphics.Image {}
