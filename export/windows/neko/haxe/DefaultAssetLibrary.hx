...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/Asteroid-0.png", "assets/images/Asteroid-0.png");
		type.set ("assets/images/Asteroid-0.png", AssetType.IMAGE);
		path.set ("assets/images/Asteroid-1.png", "assets/images/Asteroid-1.png");
		type.set ("assets/images/Asteroid-1.png", AssetType.IMAGE);
		path.set ("assets/images/Asteroid-2.png", "assets/images/Asteroid-2.png");
		type.set ("assets/images/Asteroid-2.png", AssetType.IMAGE);
		path.set ("assets/images/Asteroid-3.png", "assets/images/Asteroid-3.png");
